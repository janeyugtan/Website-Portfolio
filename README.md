<p align="center">
  <img src="jy-linkedin.jpeg" alt="Jane Yugtan" width="160" height="160" style="border-radius:50%;object-fit:cover;border:4px solid #0f4c75;" />
</p>
...
## 🤝 Clients & Websites Managed (larger, UI-styled)
<div align="left">
  <!-- row 1 -->
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="70KLOGO.webp" height="64" alt="70K Affiliates" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="dreamindigitallogo.jpeg" height="64" alt="Dream in Digital" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="threecoltslogo.png" height="64" alt="Threecolts" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="servicethrivelogo.png" height="64" alt="ServiceThrive" style="display:block;"/>
  </span>
  <!-- row 2 -->
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="Fanti-sewer-and-drain-pros-retina.png" height="64" alt="Fanti Sewer & Drain Pros" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="MW-logo.png" height="64" alt="Morgan White Window Coverings" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="san-benito-realty-hollister-ca.webp" height="64" alt="San Benito Realty" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="WL-LOGO.webp" height="64" alt="Whiskey Library" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="AA-ROOFING-LOGO-02.png" height="64" alt="AA Roofing" style="display:block;"/>
  </span>
  <!-- row 3 -->
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="highlandfarmparklogo.jpg" height="64" alt="Highland Farm Park" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="audaciouslyagencylogo.png" height="64" alt="Audaciously Agency" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="marketingmeca.jpeg" height="64" alt="Marketing Meca" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="cropped-Forget-Me-Not-02.png" height="64" alt="Forget Me Not" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="IAAlogo.png" height="64" alt="Investor Attraction Academy" style="display:block;"/>
  </span>
  <!-- row 4 -->
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="PPCLOGO.jpeg" height="64" alt="PPC (alt logo)" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="ealogo.png" height="64" alt="EA (brand asset)" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="White_WL_Logo.avif" height="64" alt="Whiskey Library (alt)" style="display:block;"/>
  </span>
</div>
...
## 🏅 Certifications (larger, UI-styled)
<div align="left">
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="verified power user  v3_1.png" height="64" alt="ClickUp Verified Power User" style="display:block;"/>
  </span>
  <span style="display:inline-block;margin:6px;padding:10px 14px;border:1px solid #e6eef7;border-radius:14px;background:#ffffff;box-shadow:0 4px 12px rgba(2,18,30,.06);">
    <img src="HubSpot%20(1).png" height="64" alt="HubSpot SEO Certification" style="display:block;"/>
  </span>
</div>
